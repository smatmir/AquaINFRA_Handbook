...
<div class="sequence-navigation">
    <a href="{{ relative_root }}trainings/pan-european-use-case/04_specleaner_package" class="btn-seq btn-seq--prev">← Previous: Specleaner</a>
    <a href="{{ relative_root }}trainings/pan-european-use-case/06_galaxy_workflow_setup" class="btn-seq btn-seq--next">Next Chapter: Galaxy Setup →</a>
</div>
